...
//            Integer value = polynomialResult.getOrDefault(entry.getKey(), 0);// Returns the value to which the specified key is mapped, or defaultValue if this map contains no mapping for the key.
